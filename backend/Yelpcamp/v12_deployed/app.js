...
// mongoose.connect( "mongodb://localhost:27017/yelp_camp_v12_001", { useNewParser: true } ) ; 
// checks if yelp_camp database is already created or not. 

var url = process.env.DATABASEURL || "mongodb://localhost:27017/yelp_camp_v12_001" ;
// if process.env.DATABASEURL does not exist or is an empty 
// string then it will be equal to the 2nd string. 
